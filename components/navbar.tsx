...
import { GithubIcon, LinkedInIcon } from "./sosial-icons";
...
const socialLinks = {
    github: 'https://github.com/AbdullohUmar',
    linkedin: 'https://www.linkedin.com/in/abdullohumar1/',
}
export const Navbar = () => {
        ...
        <motion.nav
            ...
            <div className="max-w-7xl mx-auto px-6 py-3">
                <div className="flex items-center justify-between">
                    <motion.div
                        whileHover={{ scale: 1.05 }} className="flex gap-2 items-center group">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <div className="h-100 w-px bg-white/10 mx-2"></div>
                    ...
                    <button
                        ...
                        {isMenuOpen ? (
                            <XMarkIcon className="h-5 w-5 text-content/80" />
                        ) : (
                            <Bars3Icon className="h-5 w-5 text-content/80" />
                        )}
                    </button>
                </div>
                {isMenuOpen && (
                    <motion.div
                        className="md:hidden mt-4 pb-4 space-y-4 flex flex-col gap-2">
                        {navItems.map((items) => (
                            <a
                                key={items.name}
                                href={items.href}
